...
import ayle from "../public/images/ayle.webp";
import tate from "../public/images/tate.webp";
import sarah from "../public/images/sarah.webp";
import jessica from "../public/images/jessica.webp";
...
const Testimonials = ({id}) => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      heading:"An Exceptional Experience Overall",
      image: jessica
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <blockquote className={`text-base md:text-2xl font-medium mb-4 leading-relaxed ${head.className}`}>
            "Ammara Shafiq and the team at Zentrova team aren't just designers—they're logo legends! When I needed branding for my SaaS baby, NurtureMachine, I wanted something unforgettable—and they absolutely delivered.
