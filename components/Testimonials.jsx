      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <blockquote className={`text-base md:text-2xl font-medium mb-4 leading-relaxed ${head.className}`}>
            "Zentrova team aren't just designers—they're logo legends! When I needed branding for my SaaS baby, NurtureMachine, I wanted something unforgettable—and they absolutely delivered.
