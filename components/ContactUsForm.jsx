...
const ContactUsForm = ({ isOpen, onClose }) => {
  ...
  {isOpen && (
    ...
    >
      {/* Darker Backdrop */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0a0a0a]/95 via-[#111111]/95 to-black/95 backdrop-blur-md"></div>

      <motion.div
        className="relative w-full max-w-md mx-4 bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#0a0a0a] text-gray-100 rounded-2xl shadow-2xl shadow-black/50 border border-gray-800/50 overflow-hidden"
      ...
      >
        <div className="p-6 md:p-8">
          <div className="flex justify-between items-center mb-8">
            <motion.h2 
              className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-300 to-gray-400 bg-clip-text text-transparent"
            ...
            <motion.div
              ...
              className={`p-5 mb-6 rounded-xl border ${
                submitStatus.success
                  ? "bg-emerald-900/10 text-emerald-100 border-emerald-600/20"
                  : "bg-rose-900/10 text-rose-100 border-rose-600/20"
              }`}
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {field.type === "textarea" ? (
                    <>
                      <textarea
                        ...
                        } rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all`}
                      />
                      {errors[field.name] && (
              ...
              >
                <button
                  ...
                  className="px-5 py-2.5 rounded-lg border border-gray-700 text-sm text-gray-300 hover:bg-gray-800/30 transition"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="px-5 py-2.5 rounded-lg text-sm font-medium bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-600 hover:to-gray-800 transition-all text-white shadow-lg shadow-black/30 disabled:opacity-60 flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <svg
