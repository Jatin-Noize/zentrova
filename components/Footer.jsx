...
export default function Footer() {
 ...
 quality service at the best price
  ...
  className={`relative w-44 h-12 bg-white/10 hover:bg-gradient-to-b from-zinc-700 to-orange-400 mt-6 transition-colors duration-200 text-white rounded-2xl text-sm font-medium flex items-center justify-center overflow-hidden ${footer.className}`}
          ...
          <motion.ul variants={containerVariants} className="space-y-2 text-sm">
            <motion.li variants={itemVariants}>
              <button 
                ...
                className="text-gray-300 hover:text-white transition-colors duration-200 hover:underline underline-offset-4 decoration-orange-400 text-left w-full py-1"
              >
                About Us
              </button>
            </motion.li>
